...
// //           alert(`Successfully Completed "${video.title}"`);
// //           openQuizModal(video);
// //         }
// //       } else {
...
//       const docSnap = await getDoc(docRef);
//       if (docSnap.exists()) {
//         const watchedData = docSnap.data();
//         const videoIds = (watchedData.videos || []).map((v) => v.id);
...
//               className="btn btn-success"
//             >
//               {watchedVideoIds.includes(video.id) ? "Take Quiz Again" : "Take Quiz"}
//             </button>
//           </div>
//         </div>
//       ));
        ...
        return (
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "15px" }}>
              ...
              {isWatched ? (
                <span style={{ color: "green", fontWeight: "bold", fontSize: "16px", display: "flex", alignItems: "center", gap: "6px" }}>
                  <FaCheckCircle />
                  Watched
                </span>
